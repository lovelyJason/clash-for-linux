...
Clash Dashboard 访问地址：http://<ip>:6063/ui
...
通过浏览器访问 `start.sh` 执行成功后输出的地址，例如：<http://192.168.0.1:6063/ui>

- 登录管理界面

在`API Base URL`一栏中输入：http://\<ip\>:6063 ，在`Secret(optional)`一栏中输入启动成功后输出的Secret。
